...
const api: InnocenceCodeApi = {
  ...
  reorderSessions: (groupId, orderedIds) => ipcRenderer.invoke(IPC.sidebarReorder, groupId, orderedIds),
  moveSession: (id, targetGroupId, beforeId) => ipcRenderer.invoke(IPC.sidebarMove, id, targetGroupId, beforeId),
